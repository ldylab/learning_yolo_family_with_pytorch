...
from model.yolov1.resnet import resnet18
from model.submodules import Conv, SPP
import numpy as np
from utils.yolo_tools import loss, gt_creator
import tools
...
def yolov1(num_classes, to_train=True):
    train_size = 416
    yolo_net = myYOLO(torch.device("cuda"), input_size=train_size, num_classes=num_classes, trainable=to_train)
    return yolo_net