...
from data.voc_dataset_transform import SSDAugmentation
import random
...
VOC_ROOT = "/home/henry/Desktop/YOLO/YOLO_start_from_zero/dataset"
# the size of training picture
train_size = 416
...
class VOCDetection(data.Dataset):
    ...
    def __init__(self, root=VOC_ROOT, img_size=None,
...
def VOCDataset(args, is_train, train_val_rate = 0.8):
    dataset = VOCDetection(root=VOC_ROOT,
                           transform=SSDAugmentation(train_size)
                           )

    train_dataset_size = int(train_val_rate * len(dataset))
